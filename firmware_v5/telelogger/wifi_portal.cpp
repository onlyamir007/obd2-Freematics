...
int handlerPortalHtml(UrlHandlerParam* param)
{
  static const char HTML[] =
    ...
    "<title>Amir Telelogger (based on Freematics) — portal</title><style>"
    ...
    "</style></head><body>"
    "<h1>Amir Telelogger (based on Freematics)</h1>"
    ...
    "<p style=font-size:13px;color:#444>SPP: pair a phone/PC, then use serial-style commands. The name you set applies after a reboot.</p>"
